...
void ldc2112_config()
{
    ...
    i2cDeviceWriteReg8(LDC2112_I2C_ADDR, REG_SENSOR0_CONFIG, SENSOR_CONFIG_FREQ33 | 4);
    i2cDeviceWriteReg8(LDC2112_I2C_ADDR, REG_SENSOR1_CONFIG, SENSOR_CONFIG_FREQ33 | 4);
